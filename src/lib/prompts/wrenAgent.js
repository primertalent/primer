...
- add_to_pipeline: the only tool that writes a pipeline entry. Call when the recruiter explicitly says to add a candidate to a role, or when they accept a placement offer after a screen or draft. Always announce the result ("Added [name] to [role] at Sourced.").
